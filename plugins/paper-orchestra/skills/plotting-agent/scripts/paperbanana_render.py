...
Usage:
    ...
    python paperbanana_render.py \\
        ...
        --task diagram \\
        --aspect-ratio "16:9" \\
        --out paperorchestra/figures/fig_overview.png

    # render a plot figure with fewer critic rounds
    python paperbanana_render.py \\
        --figure-id fig_results \\
        --caption "Figure 2: Comparison of baselines." \\
        --content-file paperorchestra/inputs/experimental_log.md \\
        --task plot \\
        --aspect-ratio "5:4" \\
        --max-critic-rounds 1 \\
        --out paperorchestra/figures/fig_results.png
...
def main() -> int:
    ...
    p.add_argument(
        ...
        help="Output PNG path (e.g. paperorchestra/figures/fig_overview.png)",
    )
    args = p.parse_args()

...
**File:** `paperorchestra/outline.json`
...
**Files:** `paperorchestra/figures/`, `paperorchestra/refs.bib`,
           `paperorchestra/citation_pool.json`, `paperorchestra/drafts/intro_relwork.tex`
...
**File:** `paperorchestra/drafts/paper.tex`
...
**Files:** `paperorchestra/final/paper.tex`, `paperorchestra/final/paper.pdf`,
           `paperorchestra/refinement/worklog.json`
...
## Schema 5 — Input Validation (paperorchestra/inputs/)

**Files:** `paperorchestra/inputs/` directory
